...
(case [Total # Students without Disabilities Expelled] when 0 then '--' else cast([% of Expelled Students without Disabilities Offered Post Expulsion Services] as char) end) as 'percent_of_expelled_students_without_disabilities_offered_post_expulsion_services'
