-- this is SuspensionsSchoolDistStateDataCrunch2009-09-05.sql
...
'race_ethnicity' = rtrim(RaceLabel), 'gender' = rtrim(GenderLabel),
...
--> changes with each
from v_SuspensionsSchoolDistState v_suspensions
...
--(right(fullkey,1) = 'X' and race = '9' and Gender = '9' and disabilitycode = '9' and grade in ('12','16','20','24','28','32','36','40','44','48','52','56','60','64','70','71','72','73','99')) or 
(right(fullkey,1) = 'X' and race = '9' and Gender = '9' and disabilitycode = '9' and grade in ('12','16','20','24','28','32','36','40','44','48','52','56','60','64','99')) or 
-- district level - schooltypes for races 
(right(fullkey,1) = 'X' and race <> '9' and Gender = '9' and disabilitycode = '9' and grade = '99') or 
-- district level - schooltypes for gender 
(right(fullkey,1) = 'X' and race = '9' and Gender <> '9' and disabilitycode = '9' and grade = '99') or
-- district level - schooltypes for disability 
(right(fullkey,1) = 'X' and race = '9' and Gender = '9' and disabilitycode <> '9' and grade = '99')
)

-- must filter out cross join of race/gender - redundant?
and ((race = '9' and Gender = '9' and disabilitycode = '9') or (race <> '9' and Gender = '9' and disabilitycode = '9') or (race = '9' and Gender <> '9' and disabilitycode = '9') or (race = '9' and Gender = '9' and disabilitycode <> '9'))
...
--and (fullkey = '01361903XXXX' or fullkey = '013619040022')
--and fullkey = '01361903XXXX' --and schooltype = '3'
--and [district number] = '3619'
--and race = '9' and Gender = '9' and disabilitycode = '9' 
--and grade = '99'


order by [District Number],[School Number], schooltype, grade, race, Disability, Gender
