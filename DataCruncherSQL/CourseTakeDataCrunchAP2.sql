...
(right(fullkey,1) = 'X' and sex = '9' and grade in ('40','44','48','52','56','60','64','94')) or 
...
(right(fullkey,1) = 'X' and sex <> '9' and grade in ('40','44','48','52','56','60','64','94')) 
)
...
-- test only
--and fullkey = '01071403XXXX'
--and [district number] = '3619'
--and race = '9' 
--and sex = '9' and grade = '64' and wmasid1  = '8'
--and v_Coursework.Course like '%Math%'
