...
/****** Object:  View dbo.v_EnrollFlatRaceSexGradesExSS2    Script Date: 1/23/2007 11:34:04 AM ******/
...
-- jdj 2007-01-23 - making this into a gender/ethnicity-oly view for producing datacrunch sql only 
...
'Enrollment' = 
sum(case when right(d.fullkey,1) = 'X' and left(d.fullkey,1) <> 'X' then 
-- when it's a school-level row, include only '99'
(CASE WHEN d.gradecode in ('70','71','72','73','99') AND  not (d.race <> '9' and d.sex <> '9') THEN isnull(d.enrollment,'0') ELSE 0 END)
--else 
--(CASE WHEN d.gradecode in (12,16,20,24,28,32,36,40,44,48,52,56,60,64,70,71,72,73) AND  d.race = 9 and d.sex <> 9 THEN isnull(d.enrollment,'0') ELSE 0 END)
end),
...
'Female' = sum(case when sexcode = 1 and racecode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Male' = sum(case when sexcode = 2 and racecode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Am. Ind.' = sum(case when racecode = 1 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Asian' = sum(case when racecode = 2 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Black' = sum(case when racecode = 3 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Hisp.' = sum(case when racecode = 4 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'White' = sum(case when racecode = 5 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'Comb.' = sum(case when racecode = 6 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end), 
'No Resp' = sum(case when racecode = 8 and sexcode = 9 and d.gradecode in ('70','71','72','73','99') then enrollment else 0 end)
...
--year = '2006' and [District Number] = '0714' and 
...
d.[School Name], d.LinkedName, d.LinkedDistrictName, d.LinkedSchoolName
/*
, (case when gradecode in (70,71,72,73) then gradecode else 99 end), 
...
-- below are for test only
--where year = '2006' and [District Number] = '0714'
