...
--rtrim(GradeLabel) 
rtrim(replace(GradeLabel,'Prek-12', 'PreK-12'))
end) end), 
...
v_Expulsions.[Total Enrollment Prek-12] as 'total_enrollment-Prek-12', 
isnull(v_Expulsions.[Possible Days Attendance],0) as 'possible_days_attendance', 
isnull(v_Expulsions.[DaysExpDurationTotal],0) as 'number_of_days_expelled', 
