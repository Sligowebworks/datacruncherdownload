...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[procActivitiesCommunityDataCrunch3]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[procActivitiesCommunityDataCrunch3]
GO

create procedure procActivitiesCommunityDataCrunch3 
@year char(4),
@cesa char(2)
as
