...
isnull([Number of Students Expelled],0) as 'number_of_students_expelled', 
(case v_expulsions.[Total Enrollment Prek-12] when 0 then '--' else cast(isnull([Expulsion Percent],0) as char) end) as 'expulsion_percent'
