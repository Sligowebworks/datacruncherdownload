...
v_SuspExpIncidents.Enrollment as 'enrollment_PreK-12', IncidentCountTotalWeaponDrug as 'weapon_drug_number_of_incidents', WeaponDrugIncidentRate as 'weapon_drug_incidents_per_1000_students', 
IncidentCountTotalNonWeaponDrug as 'not_weapon_drug_number_of_incidents', NonWeaponDrugIncidentRate as 'not_weapon_drug_incidents_per_1000_students'

--> changes with each
from v_suspexpincidents 
...
and ((grade >= (select distinct lowgrade from agency where  v_SuspExpIncidents.year = agency.year and v_SuspExpIncidents.agencykey = agency.agencykey) 
and grade <= (select distinct highgrade from agency where v_SuspExpIncidents.year = agency.year and v_SuspExpIncidents.agencykey = agency.agencykey))
or grade = '99'))
or 
