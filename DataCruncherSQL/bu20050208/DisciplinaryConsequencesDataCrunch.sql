...
'not_weapon_drug_percent_suspended' = [%NonWeaponDrugAllSusp], 
'not_weapon_drug_percent_expelled' = [%NonWeaponDrugExp], 
...
'weapon_drug_percent_suspended' = [%WeaponDrugAllSusp], 
'weapon_drug_percent_expelled' = [%WeaponDrugExp], 
