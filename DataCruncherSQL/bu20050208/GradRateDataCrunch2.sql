...
--where v_enrollment.year = '2003' and v_enrollment.fullkey <> 'XXXXXXXXXXXX' and v_enrollment.CESA = '02' 
...
and ((v_enrollment.grade >= (select distinct lowgrade from agency where  v_enrollment.year = agency.year and v_enrollment.agencykey = agency.agencykey) 
and v_enrollment.grade <= (select distinct highgrade from agency where v_enrollment.year = agency.year and v_enrollment.agencykey = agency.agencykey))
...
-- test only
--and v_enrollment.fullkey = '020063040040'
