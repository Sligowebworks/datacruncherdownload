...
else rtrim(replace(GradeLabel,'Prek-12', 'PreK-12'))
end) end), 
...
v_suspensions.[Total Enrollment Prek-12] as 'total_enrollment-Prek-12', isnull(v_suspensions.[Possible Days Attendance],0) as 'possible_days_attendance', isnull(v_suspensions.[Number of Days Suspended],0) as 'number_of_days_suspended', isnull(v_suspensions.[Percent of Days Suspended],0) as 'percent_of_days_suspended'
