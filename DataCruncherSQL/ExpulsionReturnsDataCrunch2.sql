...
[Students Eligible to Return to School] as 'students_eligible_to_return_to_school', 
[Students Who Returned to School] as 'students_who_returned_to_school', 
[Students Who Didn't Return to School] as 'students_who_did_not_return_to_school', 
--[% of Eligibles Who Return] as 'percent_of_eligibles_who_return'
(case [Students Eligible to Return to School]  when 0 then '--' else cast([% of Eligibles Who Return] as char) end) as 'percent_of_eligibles_who_return'
