...
/****** Object:  Stored Procedure dbo.procActivitiesOfferedCommunityDataCrunch    Script Date: 12/7/2006 12:43:10 PM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[procActivitiesOfferedCommunityDataCrunch]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[procActivitiesOfferedCommunityDataCrunch]
GO
...
where activities.code in ('re','vo') and v_enrollment.race = 9 and v_enrollment.sex = 9 
