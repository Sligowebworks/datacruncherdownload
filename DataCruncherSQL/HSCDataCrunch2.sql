...
'total_enrollment_grade_12' = (case when [Total Enrollment Grade 12] < 0 then 0 else [Total Enrollment Grade 12] end), 

'total_expected_to_complete_high_school' = [total expected to complete high school], 
'number_cohort_dropouts' =  [cohort_dropouts_count], 
'percent_cohort_dropouts' = [cohort dropouts], 
'number_students_who_reached_the_maximum_age' = [maximum_aged_count], 
'percent_students_who_reached_the_maximum_age' = [students who reached the maximum age], 
'number_certificates' = [certificate_count], 
'percent_certificates ' = [certificates], 
'number_hsed' = [hsed_count], 
'percent_hsed' = [hseds], 
'number_regular' = [regular_count], 
'percent_regular' = [regular diplomas], 
