-- can improve join in view?
-- must check school rows for nulls
...
--> changes with each
---- switching out grade output between views - until schooltypes supported in dataset
from v_suspensionsdis v_suspensions
--from v_suspensionsdisGrades v_suspensions
...
and (
-- school level
(right(fullkey,1) <> 'X' and (race = '9' and sex = '9' and grade in ('12','16','20','24','28','32','36','40','44','48','52','56','60','64','99')
...
(right(fullkey,1) = 'X' and race = '9' and sex = '9' and grade in ('12','16','20','24','28','32','36','40','44','48','52','56','60','64','70','71','72','73','99')) or 
...
and race = '9' and sex = '9' and disabilitycode = '9' and 

---- switching out grade output between views
--(
(grade = '99' and schooltype in ('3','5','6','7','9'))
--or 
--(grade in ('12','16','20','24','28','32','36','40','44','48','52','56','60','64') and schooltype = '9')
--)
...
--order by [District Number],[School Number], schooltype, grade, race, sex
