...
-- this is EnrollmentGradesDataCrunch3.sql
...
--> changes with each
from v_EnrollFlatRaceSexGradesExSS3
where year = ? and fullkey <> 'XXXXXXXXXXXX' and CESA = ?
--where year = '2006' and CESA = '05' and fullkey <> 'XXXXXXXXXXXX' 
...
(select distinct PartSchIndic from agency where  v_EnrollFlatRaceSexGradesExSS3.year = agency.year and v_EnrollFlatRaceSexGradesExSS3.agencykey = agency.agencykey) is not null 
))
