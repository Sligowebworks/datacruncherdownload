...
or (racecode <> '9' and sexcode = '9' and gradecode = '64') or (racecode = '9' and sexcode <> '9' and gradecode = '64'))
...
(right(fullkey,1) = 'X' and racecode <> '9' and sexcode = '9' and gradecode in ('70','71','72','73','64')) or 
-- district level - schooltypes for gender 
--(right(fullkey,1) = 'X' and racecode = '9' and sexcode <> '9' and gradecode in ('70','71','72','73','99'))
(right(fullkey,1) = 'X' and racecode = '9' and sexcode <> '9' and gradecode in ('70','71','72','73','64'))
)
...
-- filtering out invalid agencytypes
