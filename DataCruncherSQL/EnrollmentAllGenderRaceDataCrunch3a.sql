...
[GradeCode], [GradeLabel], [GradeShortLabel],
...
FROM [wisconsin].[dbo].[v_EnrollFlatRaceSexGradesExSS]

--where year = ? and fullkey <> 'XXXXXXXXXXXX' and CESA = ?
where year = '2004' and fullkey <> 'XXXXXXXXXXXX' and CESA = '01' 
--and fullkey <> 'XXXXXXXXXXXX'
and (fullkey = 'XXXXXXXXXXXX' or fullkey = '01361903XXXX' or fullkey = '013619040022')
and 
(grade = '99' 
...
--and right(left(fullkey,6),4) = '3619'
