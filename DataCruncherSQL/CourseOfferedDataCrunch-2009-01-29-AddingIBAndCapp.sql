...
'grade_label' = (case rtrim(GradeLabel) when 'Grades PreK-12' then 'Grades 6-12' else rtrim(GradeLabel) end), 
...
--> changes with each
right(left(fullkey,8),6) = '361914' and (select distinct PartSchIndic from agency where  v_course_offerings.year = agency.year and v_course_offerings.agencykey = agency.agencykey) is not null 
))
...
--and coursetypeid in ('1','2','3','4') and wmasid1 in 
and coursetypeid in ('1','2','6','4') and wmasid1 in 
--('4','8','10','11','1','2','3','5','6','7','9','12','13')
('4','8','10','11','2','6','9','13')
...
order by [District Number],[School Number], CourseType, WMASID1, v_course_offerings.course, v_course_offerings.Offerings 