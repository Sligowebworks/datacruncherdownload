...
'N Min. Perf.' = dbo.ConvertFloatToCharAndTrapNumericCodes([Number Minimal]), 
'N Basic' = dbo.ConvertFloatToCharAndTrapNumericCodes([Number Basic]), 
'N Proficient' = dbo.ConvertFloatToCharAndTrapNumericCodes([Number Proficient]), 
'N Advanced' = dbo.ConvertFloatToCharAndTrapNumericCodes([Number Advanced]), 
...
'% Min. Perf.' = dbo.ConvertFloatToCharAndTrapNumericCodes([Percent Minimal]), 
'% Basic' = dbo.ConvertFloatToCharAndTrapNumericCodes([Percent Basic]), 
'% Proficient' = dbo.ConvertFloatToCharAndTrapNumericCodes([Percent Proficient]), 
'% Advanced' = dbo.ConvertFloatToCharAndTrapNumericCodes([Percent Advanced])
