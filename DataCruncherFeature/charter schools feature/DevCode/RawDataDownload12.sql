...
-- must be sure that agency keys in download files are from tblAgency, not WSAS - WSAS agencykeys not trustworthy
'tblAgency_key' = tblAgency.[AgencyKEY], 
...
--, [Enrolled], 'No WSAS' = [No WSAS Total], 'Min Perf' = MinPerfWSAS, 'Basic' = BasicWSAS, 'Proficient' = ProficientWSAS, 
...
--year = '2006' 
-- breaks prior to 2004 - varchar to float conversion error
v_WSASWithCounts.year = '2003' 

--and Fullkey = '01361903XXXX' 
--and v_WSASWithCounts.Fullkey = '01361903XXXX' 
and 
v_WSASWithCounts.Fullkey = '013619040022' 
--and Groupnum = '7' 
