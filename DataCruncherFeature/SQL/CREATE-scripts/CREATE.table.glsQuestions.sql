...
SET @Question = 'How did students perform on state tests at grades 3-8 and 10?'
--SET @Display = '<a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">' + @Question + '</a>'
--SET @Display = '<font color="#000000">' + @Question + '<br>Coming soon.  You may </font><a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
--SET @Display = @Question + '<br><font color="#000000">Coming soon.  You may </font><a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
SET @Display = @Question + '<br><font color="#000000">Coming soon.  You may </font><a href="http://www.dpi.state.wi.us/oea/hist/profic.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
INSERT glsQuestions (CategoryKey, Question, Display, Sort, [disabled]) 
VALUES (@CatKey,           @Question,	@Display	, @Sort, 'DISABLED' ) 
SET @Sort = @Sort + 1
...
--SET @Display = '<a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">' + @Question + '</a>'
--SET @Display = '<font color="#000000">' + @Question + '<br>You may </font><a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
--SET @Display = @Question + '<br><font color="#000000">You may </font><a href="http://www.dpi.state.wi.us/oea/kcrawdat.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
SET @Display = @Question + '<br><font color="#000000">You may </font><a href="http://www.dpi.state.wi.us/oea/hist/profic.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
INSERT glsQuestions (CategoryKey, Question, Display, Sort, [disabled]) 
VALUES (@CatKey,           @Question,	@Display	, @Sort, 'DISABLED' ) 
SET @Sort = @Sort + 1	

--SET @Question = 'How did students perform on the state reading test at grade 3?'
SET @Question = 'How did students perform on the Wisconsin Reading Comprehension Test? (Last administered March 2005)'
--SET @Display = '<a href="http://www.dpi.state.wi.us/oea/spr_wrct.html" target="_new">' + @Question + '</a>'
--SET @Display = '<font color="#000000">How did students perform on the state reading test at grade 3?<br>Coming Soon.  You may </font><a href="http://www.dpi.state.wi.us/oea/spr_wrct.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
--SET @Display = '<font color="#000000">' + @Question + '<br>You may </font><a href="http://www.dpi.state.wi.us/oea/spr_wrct.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
SET @Display = @Question + '<br><font color="#000000">You may </font><a href="http://www.dpi.state.wi.us/oea/spr_wrct.html" target="_new">download these data from another page</a><font color="#000000">.</font>'
INSERT glsQuestions (CategoryKey, Question, Display, Sort, [disabled]) 
VALUES (@CatKey,           @Question,	@Display	, @Sort, 'DISABLED' ) 
SET @Sort = @Sort + 1
...
SET @Display = @Question
--SET @Display = @Question + '&nbsp;<a href="http://www.dpi.state.wi.us/sig/data/xls/act05.xls" target="_new">Download 2004-05 ACT data from another page.</a>'
INSERT glsQuestions (CategoryKey, Question, Display, Sort) 
VALUES (@CatKey,	@Question,	@Display	, @Sort )
SET @Sort = @Sort + 1

SET @Question = 'What are the high school completion rates?'
SET @Display = 'What are the high school completion rates? (Schools with grade 12 only)'
INSERT glsQuestions (CategoryKey, Question, Display, Sort) 
VALUES (@CatKey,	@Question,	@Display	, @Sort )
SET @Sort = @Sort + 1	
...
--SET @Display = '<font color="#000000">' + @Question + '<br>You may </font><a href="http://www2.dpi.state.wi.us/sfsdw/" target="_new">download these data from another page</a><font color="#000000">.</font>'
SET @Display = @Question + '<br><font color="#000000">You may </font><a href="http://www2.dpi.state.wi.us/sfsdw/" target="_new">download these data from another page</a><font color="#000000">.</font>'
INSERT glsQuestions (CategoryKey, Question, Display, Sort, [disabled]) 
VALUES (@CatKey,           @Question,	@Display	, @Sort, 'DISABLED' ) 
SET @Sort = @Sort + 1	
